      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            ...
            <a
              href="mailto:support@ternahealth.com"
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    size={20}
                    className={`flex-shrink-0 mt-0.5 transition-transform ${isOpen ? "rotate-180 text-brand" : "text-gray-400"}`}
                  />
                </button>
                {isOpen && (
