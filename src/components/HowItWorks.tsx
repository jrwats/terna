      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          {steps.map((step, i) => {
            ...
            return (
              <Reveal key={i} delay={i * 120} className="relative z-10 flex flex-col items-center text-center bg-white">
                <div className="relative mb-6">
                  ...
                  <span className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-brand-light text-gray-900 text-xs font-bold flex items-center justify-center">
                    {step.number.slice(1)}
                  </span>
                </div>
        ...
        <Reveal delay={400} className="text-center mt-14">
          <a
            href="#plans"
            className="inline-flex items-center px-10 py-4 bg-brand hover:bg-brand-dark text-white font-bold text-base rounded-full transition-colors shadow-lg"
          >
