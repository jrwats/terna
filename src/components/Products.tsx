      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <ProductCard
            ...
            gradient="from-purple-50 to-brand-bg"
          />
          <ProductCard
            name="Tirzepatide"
...
const ProductCard = ({
  ...
  >
    ...
    <div className="w-24 h-24 rounded-2xl bg-white shadow-md flex items-center justify-center mb-6 border border-gray-100">
      ...
      >
        <rect x="18" y="4" width="12" height="40" rx="6" fill="#aa3bff" opacity="0.8" />
        <rect x="4" y="18" width="40" height="12" rx="6" fill="#aa3bff" opacity="0.4" />
      </svg>
    </div>
